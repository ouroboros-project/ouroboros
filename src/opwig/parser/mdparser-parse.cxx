// Generated by Bisonc++ V4.02.01 on Wed, 10 Apr 2013 10:34:23 -0300
...
PI__ const s_productionInfo[] = 
{
     ...
     {363, 1}, // 53: access_specifier (PRIVATE) ->  PRIVATE
     {363, 1}, // 54: access_specifier (PROTECTED) ->  PROTECTED
     {363, 1}, // 55: access_specifier (PUBLIC) ->  PUBLIC
     {364, 3}, // 56: class_specifier ('{') ->  class_head '{' '}'
     {365, 1}, // 57: class_head ->  class_key
     {365, 2}, // 58: class_head ->  class_key base_clause
     {365, 2}, // 59: class_head ->  class_key class_head_name
     {365, 3}, // 60: class_head ->  class_key class_head_name base_clause
     {367, 1}, // 61: class_head_name ->  class_name
     {368, 2}, // 62: base_clause (':') ->  ':' base_specifier_list
     {369, 1}, // 63: base_specifier_list ->  base_specifier
     {369, 3}, // 64: base_specifier_list (',') ->  base_specifier_list ',' base_specifier
     {370, 1}, // 65: base_specifier ->  base_type_specifier
     {370, 2}, // 66: base_specifier (VIRTUAL) ->  VIRTUAL base_type_specifier
     {370, 2}, // 67: base_specifier ->  access_specifier base_type_specifier
     {370, 3}, // 68: base_specifier (VIRTUAL) ->  VIRTUAL access_specifier base_type_specifier
     {370, 3}, // 69: base_specifier (VIRTUAL) ->  access_specifier VIRTUAL base_type_specifier
     {371, 1}, // 70: base_type_specifier ->  class_name
     {372, 1}, // 71: class_name ->  identifier
     {366, 1}, // 72: class_key (CLASS) ->  CLASS
     {366, 1}, // 73: class_key (UNION) ->  UNION
     {366, 1}, // 74: class_key (STRUCT) ->  STRUCT
...
{
    { { REQ_TOKEN}, { 12} },                       
    { {       369}, { 91} }, // base_specifier_list
    { {       370}, { 92} }, // base_specifier     
    { {       371}, { 93} }, // base_type_specifier
    { {       291}, { 94} }, // VIRTUAL            
    { {       363}, { 95} }, // access_specifier   
    { {       372}, { 96} }, // class_name         
    { {       272}, { 97} }, // PRIVATE            
    { {       273}, { 98} }, // PROTECTED          
    { {       274}, { 99} }, // PUBLIC             
...
{
    { { REQ_TOKEN}, {   9} },                       
    { {       371}, { 114} }, // base_type_specifier
    { {       363}, { 115} }, // access_specifier   
    { {       372}, {  96} }, // class_name         
    { {       272}, {  97} }, // PRIVATE            
    { {       273}, {  98} }, // PROTECTED          
    { {       274}, {  99} }, // PUBLIC             
...
#line 31 "grammar/declaration_rules.gr"
        ...
        case 11:
#line 43 "grammar/declaration_rules.gr"
        { d_val__.get<Tag__::Type>() = d_vsp__[0].data<Tag__::Type>(); }
        break;

        case 12:
#line 45 "grammar/declaration_rules.gr"
        { d_val__.get<Tag__::Type>() = d_vsp__[0].data<Tag__::Type>(); }
        break;
...
#line 15 "grammar/class_rules.gr"
        ...
        case 58:
#line 17 "grammar/class_rules.gr"
...
#line 33 "grammar/class_rules.gr"
        ...
        case 64:
#line 38 "grammar/class_rules.gr"
        {
...
#line 49 "grammar/class_rules.gr"
        ...
        case 68:
#line 51 "grammar/class_rules.gr"
