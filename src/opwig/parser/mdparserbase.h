...
// $insert polymorphicSpecializations
    template <>
    struct TagOf<md::NestedNameSpecifier>
    {
        static Tag__ const tag = Tag__::NestedNameSpec;
    };
    ...
    template <>
    struct TagOf<parser::ClassHeadPair>
    {
        static Tag__ const tag = Tag__::ClassHead;
    };

    template <>
    struct TagOf<parser::EnumHeadPair>
    {
        static Tag__ const tag = Tag__::EnumHead;
    };

    template <>
    struct TagOf<std::shared_ptr<md::Type>>
    {
        static Tag__ const tag = Tag__::TypePtr;
    };

    template <>
    struct TagOf<std::shared_ptr<TypeActionList>>
    {
        static Tag__ const tag = Tag__::TypeSeq;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::NestedNameSpec>
    {
        typedef md::NestedNameSpecifier DataType;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::ClassHead>
    {
        typedef parser::ClassHeadPair DataType;
    };

    template <>
    struct TypeOfBase<Tag__::EnumHead>
    {
        typedef parser::EnumHeadPair DataType;
    };

    template <>
    struct TypeOfBase<Tag__::TypePtr>
    {
        typedef std::shared_ptr<md::Type> DataType;
    };

    template <>
    struct TypeOfBase<Tag__::TypeSeq>
    {
        typedef std::shared_ptr<TypeActionList> DataType;
    };
