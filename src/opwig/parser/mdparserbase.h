...
// $insert polymorphicSpecializations
    ...
    template <>
    struct TagOf<std::shared_ptr<NamespaceActionList>>
    {
    ...
    {
        typedef std::shared_ptr<NamespaceActionList> DataType;
    };
    ...
    {
        typedef NamespaceAction DataType;
    };
