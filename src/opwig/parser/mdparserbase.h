...
// $insert polymorphicSpecializations
    ...
    template <>
    struct TagOf<parser::DeclaratorList>
    {
        static Tag__ const tag = Tag__::DeclaratorList;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::DeclaratorList>
    {
        typedef parser::DeclaratorList DataType;
    };
