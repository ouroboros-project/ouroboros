...
// $insert polymorphicSpecializations
    template <>
    struct TagOf<std::shared_ptr<parser::ParameterList>>
    {
    ...
    template <>
    struct TagOf<parser::AccessSpecifier>
    {
    ...
    {
        typedef std::shared_ptr<parser::ParameterList> DataType;
    };
    ...
    {
        typedef parser::AccessSpecifier DataType;
    };
    ...
    {
        typedef parser::Parameter DataType;
    };
