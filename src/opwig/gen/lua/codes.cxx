...
string MiddleBlockCode (const string& module_name) {
    return
        ...
        "    ModuleInfo (const string& name, luaL_Reg the_getters[], luaL_Reg the_setters[],\n"
...
string Utilities () {
    return
        "void OPWIG_Lua_MakeParentModule (State& L, const ModuleInfo* parent) {\n"
        ...
        "    if (!parent) return;\n"
        "    OPWIG_Lua_MakeParentModule(L, parent->parent);\n"
        ...
        "        OPWIG_Lua_MakeParentModule(L, info->parent);\n"
        "    }\n"
        "}\n\n"
        ;
}
