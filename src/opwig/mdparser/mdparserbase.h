...
#include <stdexcept>
#include <type_traits>
#include <opwig/mdparser/mdparser-preincludes.h>
...
// $insert polymorphicSpecializations
    ...
    template <>
    struct TagOf<MDNamespace::Ptr>
    {
        static Tag__ const tag = Tag__::Namespace;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::Namespace>
    {
        typedef MDNamespace::Ptr DataType;
    };
